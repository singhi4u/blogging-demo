package com.nandus.rakesh.blog.demo.blogdemo.config;
...
import com.nandus.rakesh.blog.demo.blogdemo.service.GroupUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .authorizeRequests().antMatchers("/api/user/**","/api/posts","/posts/**","/api/post/**").authenticated()
        .and().httpBasic();
        //.formLogin();
